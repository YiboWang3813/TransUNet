...
file_name = './log/oasis_transunet.txt'
...
for i in range(1, num_samples + 1):
    ...
    if i == 1: 
        ...
        idx = 120  
        img_transunet = outWarped[:, :, idx] 
        mask_transunet = warped_seg[:, :, idx] 
        cv2.imwrite('./fig/img_transunet.png', img_transunet) 
        cv2.imwrite('./fig/mask_transunet.png', mask_transunet) 
        # flow 
        ...
        cv2.imwrite('./fig/flow_transunet.png', sliceXYZ) 
print('-------------------- TransUnet Test End --------------------')  
