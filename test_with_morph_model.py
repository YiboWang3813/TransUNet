...
for i in range(1, num_samples + 1):
    ...
    if i == 1: 
        ...
        idx = 120 
        img_vm = outWarped[:, :, idx] 
        mask_vm = warped_seg[:, :, idx] 
        cv2.imwrite('./fig/img_vm.png', img_vm) 
        cv2.imwrite('./fig/mask_vm.png', mask_vm) 
        # flow 
        ...
        cv2.imwrite('./fig/flow_vm.png', sliceXYZ) 
print('-------------------- VM Test End --------------------')  
