...
# file_name = './log/lpba_cc.txt' 
file_name = './log/oasis_cc.txt'
...
for i in range(1, num_samples + 1):
    ...
    if i == 1: 
        ...
        idx = 120 
        img_cc = outWarped[:, :, idx] 
        mask_cc = warped_seg[:, :, idx] 
        cv2.imwrite('./fig/img_cc.png', img_cc) 
        cv2.imwrite('./fig/mask_cc.png', mask_cc) 
        # flow 
        ...
        cv2.imwrite('./fig/flow_cc.png', sliceXYZ) 
print('-------------------- CC Test End --------------------')  
