...
# file_name = './log/lpba_vtn.txt' 
file_name = './log/oasis_vtn.txt' 
...
for i in range(1, num_samples + 1):
    ...
    if i == 1: 
        ...
        idx = 120 
        img_vtn = outWarped[:, :, idx] 
        mask_vtn = warped_seg[:, :, idx] 
        cv2.imwrite('./fig/img_vtn.png', img_vtn) 
        cv2.imwrite('./fig/mask_vtn.png', mask_vtn) 
        # flow 
        ...
        cv2.imwrite('./fig/flow_vtn.png', sliceXYZ) 
print('-------------------- VTN Test End --------------------')  
