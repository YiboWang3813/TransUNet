...
from models.swinunet_model import SwinUnetModel 
...
# file_name = './log/lpba_vm.txt'
file_name = './log/oasis_swinunet.txt'
...
for i in range(1, num_samples + 1):
    ...
    if i == 1: 
        ...
        idx = 120  
        img_swinunet = outWarped[:, :, idx] 
        mask_swinunet = warped_seg[:, :, idx] 
        cv2.imwrite('./fig/img_swinunet.png', img_swinunet) 
        cv2.imwrite('./fig/mask_swinunet.png', mask_swinunet) 
        # flow 
        ...
        cv2.imwrite('./fig/flow_swinunet.png', sliceXYZ) 
print('-------------------- SwinUnet Test End --------------------')  
